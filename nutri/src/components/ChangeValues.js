...
class ChangeValues extends React.Component {
    ...
    setValues = (e) => {
        ...
        this.setValInDb(userId, valId, newVal).then(this.props.func)
    ...
    render() {
        return (
            <div><br/><br/> Change value:
                <FormControl className="FormControl" sx="width: 20%; margin-right: 20px; margin-left: 10px">
                    <InputLabel id="demo-simple-select-label">Vitamin</InputLabel>
                ...
                <TextField placeholder="insert a new value" id="outlined-basic" variant="outlined" type="number" onChange={this.textChange}/>
                <Button sx="margin-left: 20px; margin-top: 10px;" variant="contained" color="success" onClick={this.setValues}>Set Values</Button>
